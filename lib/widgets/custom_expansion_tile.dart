...
class CustomExpansionTile extends StatefulWidget {
  ...
  CustomExpansionTile({
    ...
    this.marginLeft = 0,
    this.borderBottomColor = const Color(0xFFF2F2F7),
    this.tlRadius = 0,
    this.trRadius = 0,
    this.blRadius = 0,
    this.brRadius = 0,
          ...
          ListTileTheme.merge(
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border(
                    bottom:
                        BorderSide(width: 0, color: widget.borderBottomColor)),
              ),
              child: ListTile(
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.only(
                        topLeft: Radius.circular(widget.tlRadius),
                        topRight: Radius.circular(widget.trRadius),
                        bottomLeft: Radius.circular(widget.blRadius),
                        bottomRight: Radius.circular(widget.brRadius))),
